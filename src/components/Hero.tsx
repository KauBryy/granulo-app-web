      ...
      <div className="container relative mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="mb-12 flex flex-wrap justify-center lg:justify-start gap-4 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              <Button 
                size="lg" 
            ...
            <div className="grid grid-cols-2 gap-6 md:gap-8 animate-scale-in" style={{ animationDelay: "0.3s" }}>
